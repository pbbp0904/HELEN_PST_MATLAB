...
save(strcat(FlightFolder,"4-Datastore\PayloadEnvData-Refined.mat"),'PayloadEnvDatastore','-v7.3');
...
save(strcat(FlightFolder,"4-Datastore\PayloadRadData-Refined.mat"),'PayloadRadDatastore','-v7.3');
